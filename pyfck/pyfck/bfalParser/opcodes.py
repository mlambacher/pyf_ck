...
OPCODE_TYPES = {
  ...
  OPCODES.PUSH: (OPCODE_CLASSES.INSTRUCTION, ('V', 'R')),
  OPCODES.POP: (OPCODE_CLASSES.INSTRUCTION, ('R',)),
  ...
  OPCODES.ZERO: (OPCODE_CLASSES.INSTRUCTION, ('V', 'R')),
  OPCODES.NOT_ZERO: (OPCODE_CLASSES.INSTRUCTION, ('V', 'R')),
  OPCODES.EQUAL: (OPCODE_CLASSES.INSTRUCTION, ('VV', 'RV', 'RR')),
