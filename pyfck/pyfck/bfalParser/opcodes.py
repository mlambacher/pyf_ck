...
OPCODE_IDENTIFIERS = {
  ...
  'NOT': OPCODES.NOT,
  'NZ': OPCODES.NOT_ZERO,
  'NE': OPCODES.NOT_EQUAL,
  'GT': OPCODES.GREATER,
  'GE': OPCODES.GREATER_EQUAL,
  'LT': OPCODES.LESS,
  'LE': OPCODES.LESS_EQUAL,
...
OPCODE_TYPES = {
  ...
  OPCODES.ADD: (OPCODE_CLASSES.INSTRUCTION, ('RVV', 'RRV', 'RRR')),
  OPCODES.SUB: (OPCODE_CLASSES.INSTRUCTION, ('RVV', 'RRV', 'RRR')),
  OPCODES.MUL: (OPCODE_CLASSES.INSTRUCTION, ('RVV', 'RRV', 'RRR')),
  OPCODES.DIV: (OPCODE_CLASSES.INSTRUCTION, ('RVV', 'RRV', 'RRR')),

  OPCODES.TRUE: (OPCODE_CLASSES.INSTRUCTION, ('',)),
  OPCODES.FALSE: (OPCODE_CLASSES.INSTRUCTION, ('',)),
  OPCODES.NOT: (OPCODE_CLASSES.INSTRUCTION, ('',)),
  ...
  OPCODES.GREATER_EQUAL: (OPCODE_CLASSES.INSTRUCTION, ('VV', 'RV', 'RR')),
  OPCODES.LESS: (OPCODE_CLASSES.INSTRUCTION, ('VV', 'RV', 'RR')),
  OPCODES.LESS_EQUAL: (OPCODE_CLASSES.INSTRUCTION, ('VV', 'RV', 'RR')),
